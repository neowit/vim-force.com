...
function s:getFilesLightningComponentBundle(fName)
    ...
    let metaContent = metaContent + ["    <!-- <target>analytics__Dashboard</target> -->"]
    let metaContent = metaContent + ["    <!-- <target>lightningCommunity__Page_Layout</target> -->"]
    let metaContent = metaContent + ["    <!-- <target>lightningCommunity__Theme_Layout</target> -->"]
    let metaContent = metaContent + ["    <!-- <target>lightningSnapin__ChatHeader</target> -->"]
    let metaContent = metaContent + ["    <!-- <target>lightningSnapin__Minimized</target> -->"]
    let metaContent = metaContent + ["    <!-- <target>lightningSnapin__PreChat</target> -->"]
    let metaContent = metaContent + ["    <!-- <target>lightningStatic__Email</target> -->"]
